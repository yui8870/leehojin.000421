...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>portfolio - 이호진 웹디자이너</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <ul id="portfolio-filter">
                            ...
                            <li data-filter=".filter-1">Detailed Page</li>
                            <li data-filter=".filter-2">Event Page</li>
                            <li data-filter=".filter-3">banner</li>
                            <li data-filter=".filter-4">Package Design</li>
                        </ul>
                    </div>
                </div>
